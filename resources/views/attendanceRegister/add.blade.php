    ...
    <div class="col-md-12 stretch-card">
        <div class="card">
            <div class="container-fluid mt-2 w-100">
                <h4 class="float-left mt-4 ml-2">Employees Attendance Register</h4>
                <a href="search" class="btn btn-primary btn-sm mt-3 float-right" role="button"><i
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                {!! Form::open(array('route' => 'storeAttRegister', 'method'=>'POST','files'=>true),
                                array('employeesRegisterArray' => $employeesRegisterArray)) !!}
                                ...
                                <div class="row">
                                 ...
                                 'day3' => $day3, 'day4' => $day4, 'day5' => $day5, 'day6' => $day6, 'day7' => $day7])!!}"
                                            class="btn btn-default">&laquo;</a>
                                        @if($paginateRight == 'Yes')
                                        <td><input type="submit" value="&raquo;" /></td>
                                        @endif
                                    </div>
                                    <div class="col-xs-6 text-right">
                                        <a href="{{ url('attendanceRegister/search') }}" role="button"
                                            class="btn btn-default">Filter</a>
                                    </div>
                                </div>
                                ...
                                <table class="table" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-text">
                                                <a
                                                    href="{!!URL::route('editEmployee', ['id' => $employee->id])!!}">{{ $employee->name }}</a>
                                            </td>
                                            ...
                                            @if($day1)
                                            <td class="table-text">
                                                <input type="text" required name="day1Register[]"
                                                    value="{{ $employee->day1Reg }}" id="day1" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day2)
                                            <td class="table-text">
                                                <input type="text" required name="day2Register[]"
                                                    value="{{ $employee->day2Reg }}" id="day2" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day3)
                                            <td class="table-text">
                                                <input type="text" required name="day3Register[]"
                                                    value="{{ $employee->day3Reg }}" id="day3" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day4)
                                            <td class="table-text">
                                                <input type="text" required name="day4Register[]"
                                                    value="{{ $employee->day4Reg }}" id="day4" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day5)
                                            <td class="table-text">
                                                <input type="text" required name="day5Register[]"
                                                    value="{{ $employee->day5Reg }}" id="day5" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day6)
                                            <td class="table-text">
                                                <input type="text" required name="day6Register[]"
                                                    value="{{ $employee->day6Reg }}" id="day6" class="form-control">
                                            </td>
                                            @endif
                                            ...
                                            @if($day7)
                                            <td class="table-text">
                                                <input type="text" required name="day7Register[]"
                                                    value="{{ $employee->day7Reg }}" id="day7" class="form-control">
                                            </td>
                                            @endif
                                        </tr>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 pt-5">
                                    <a href="{!!URL::route('searchAttRegister')!!}" class="btn btn-sm btn-info "
